...
- **Pending (next session)**: (1) M5 structural test (if psychology-agent directs). (2) CC/CO monitoring. (3) Notify unratified-agent of calibration-v4 deployment (fold into PR #37 response or next unratified message).
