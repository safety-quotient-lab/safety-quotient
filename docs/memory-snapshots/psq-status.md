...
**B3 (TE uniformity) F3b COMPLETE; v32 REJECTED 2026-03-07:**
  ...
  F3: 500 TE texts scored, ingested, drove v31 (TE=0.773, overall=0.679) — REJECTED.
  F3b: 700 TE texts scored (score=5=9.9%), ingested, drove v32 (TE=0.739, overall=0.676) — REJECTED.
  TE REGRESSED −0.034 vs v31 despite 700 high-quality texts. 1,200 total expansion texts insufficient.
  B3 STALLED — diminishing returns. Strategy decision pending.
  B3 F1 (recalibrate) deferred until a model beats v23.
**Known open issues:**
  ...
  - WEIRD assumptions
  - B3 F1 (calibration dead zone): deferred — recalibrate v32 with --n-bins 20 after training
